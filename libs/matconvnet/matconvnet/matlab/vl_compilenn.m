...
flags.nvcc = {'-D_FORCE_INLINES', '--std=c++11', sprintf('-I"%s"',fullfile(matlabroot,'extern','include')), sprintf('-I"%s"',fullfile('compatibility/parallel/','gpu','extern','include')), opts.cudaArch} ;
